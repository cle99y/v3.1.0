...
public class OptionsState extends States {
    ...
    private String[] labels = {"Normal", "Tricky", "Annoying", "Save Selection"};
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (xBounds) {
                ...
                if (menuSelect.y > buttonBounds[0] && menuSelect.y < buttonBounds[0] + button.getButtonHeight()) {
                    Preferences.setDifficulty(Preferences.EASY);
                }
    ...
    public void drawButtons(SpriteBatch sb) {
        ...
        label.setText(titleFont, "LEVEL OF DIFFICULTY");
        ...
        for (int b = 0; b < numberOfButtons; b++) {
            ...
            if (Preferences.getDifficulty() == b) {
                // show the default selection to the user
